...
variant=${VARIANT}
arch=${arch}
configure_flags=--enable-version3 --disable-stripping --enable-libdrm --enable-rkmpp --enable-rkrga --disable-libxcb --disable-iconv --disable-zlib --disable-lzma --disable-alsa --disable-muxer=spdif --disable-demuxer=spdif --enable-mbedtls --enable-pic --extra-cflags=-fPIC
debug_level=-g1
INFO
